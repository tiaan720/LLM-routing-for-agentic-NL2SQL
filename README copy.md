...
This repository implements an intelligent LLM routing system that automatically selects the optimal language model for SQL query generation tasks. The system evaluates multiple routing strategies and compares their performance against baseline approaches.

![alt text](<ds-masters-Full arch.png>)
